...
(function () {
  ...
  function openUpgrade(reason) {
    ...
    /* Providers without a configured link stay OUT of the UI entirely.
       Gumroad is the storefront and always shows; Stripe and Buy Me a
       Coffee appear the moment their links land in config.js — available,
       never required. */
    stripeBtn.hidden = !stripeLink;
    bmacBtn.hidden = !bmacLink;
