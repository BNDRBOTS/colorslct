...
(function () {
  ...
  function initConsentBanner() {
    ...
    banner.innerHTML =
      ...
      '<p class="consent-text"><strong>Your colors never leave this browser.</strong> ColorSLCT uses your browser\u2019s local storage to remember palettes and settings — no cookies, no tracking, nothing leaves this browser. Want it to remember?</p>' +
      ...
      '<a class="consent-privacy" href="privacy.html">Privacy policy</a>' +
      "</div></div>";
    ...
    document.getElementById("consentDecline").addEventListener("click", function () {
      ...
      banner.classList.remove("show");
      setTimeout(function () { banner.remove(); }, 400);
      showToast("Nothing will be saved between visits.");
