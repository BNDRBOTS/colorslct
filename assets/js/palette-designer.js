...
(function (root, factory) {
  ...
  var MOODS = {
    ...
    earthy: {
      ...
      chromaFrac: [0.35, 0.55], accentL: [0.34, 0.46], darkAccentFloor: 2.5,
    ...
    professional: {
      ...
      chromaFrac: [0.50, 0.70], accentL: [0.38, 0.50],
  ...
  var AUTO_PICKS = {
    ...
    professional: [["complementary", 4], ["split", 3], ["triadic", 2], ["tetradic", 1], ["golden", 1]],
  };
  ...
  function buildAccent(rng, M, H, bgLight, bgDark) {
    ...
    var down = fitTowards(L, C, H, bgLight, lf, -1);
    L = down.L;
  ...
  /* ---------- palette-level anti-duplicate memory ----------
     ...
     the last 64 seedless palettes is re-rolled (up to 10 tries, best kept), so
