...
(function (root, factory) {
  ...
  var MOODS = {
    ...
    pastel: {
      ...
      bgPersona: [0.40, 0.50, 0.10], darkPersona: [0.35, 0.40],
    ...
    earthy: {
      ...
      bgPersona: [0.10, 0.32, 0.36], darkPersona: [0.20, 0.35],
    ...
    professional: {
      ...
      bgPersona: [0.38, 0.32, 0.20], darkPersona: [0.40, 0.40],
  ...
  function buildAccent(rng, M, H, bgLight, bgDark) {
    ...
    var down = fitTowards(L, C, H, bgLight, 3.5, -1);
    L = down.L;
  ...
  function designPalette(opts) {
    ...
    var floor = M.contrastRef === "dark" ? 3.5 : 3;
    var guard = 0;
    while (guard++ < 26) {
      ...
      bgDark = toHex(Math.max(0.045, dl[0] - 0.016), dl[1], dl[2]);
    }
